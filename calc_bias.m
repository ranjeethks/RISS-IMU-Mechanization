...
hh=figure;
   subplot(3,1,1);
   %title('Attitude error plot ','fontweight','bold','fontsize',12);
  plot(x_pitch-(ins_PVA.INS_Pitch(1:plot_len))','r','LineWidth',2); hold on; plot(n_pitch-(ins_PVA.INS_Pitch(1:plot_len))','b','LineWidth',2); %hold on; plot(ins_PVA.INS_Pitch(1:plot_len),'g');
  grid on;
